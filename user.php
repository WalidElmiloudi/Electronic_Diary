...
<body class="bg-black w-full h-screen">
  <section class ="fixed bottom-0 w-full h-20 bg-gray-900 border border-green-600 flex justify-center items-center gap-2">
  ...
  <button class="py-2 px-2 rounded-md border border-green-600 text-green-600 hover:bg-green-600 hover:text-white cursor-pointer"><a href="logout.php">Log Out</a></button>
  </section>
